...
public class IBuyPanelItem : Il2CppObjectBase
{
	...
	static IBuyPanelItem()
	{
		Il2CppClassPointerStore<IBuyPanelItem>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ExposureUnnoticed2.ObjectUI.BuyPanel", "IBuyPanelItem");
		NativeMethodInfoPtr_get_NameKey_Public_Abstract_Virtual_New_get_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IBuyPanelItem>.NativeClassPtr, 100670748);
		NativeMethodInfoPtr_get_Price_Public_Abstract_Virtual_New_get_Int32_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<IBuyPanelItem>.NativeClassPtr, 100670749);
	}

	public IBuyPanelItem(IntPtr pointer)
		: base(pointer)
	{
	}
}
