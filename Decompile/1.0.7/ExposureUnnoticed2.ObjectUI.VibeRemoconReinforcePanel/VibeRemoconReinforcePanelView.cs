...
public class VibeRemoconReinforcePanelView : BasePanelView
{
	[System.Serializable]
	[ObfuscatedName("ExposureUnnoticed2.ObjectUI.VibeRemoconReinforcePanel.VibeRemoconReinforcePanelView/<>c")]
	public sealed class __c : Il2CppSystem.Object
	{
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 87128, XrefRangeEnd = 87131, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		static __c()
		{
			Il2CppClassPointerStore<__c>.NativeClassPtr = IL2CPP.GetIl2CppNestedType(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, "<>c");
			...
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__c>.NativeClassPtr, 100669685);
			NativeMethodInfoPtr__RefreshView_b__6_0_Internal_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<__c>.NativeClassPtr, 100669686);
		}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 87131, XrefRangeEnd = 87132, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(4)]
	[CachedScanResults(RefRangeStart = 87168, RefRangeEnd = 87172, XrefRangeStart = 87132, XrefRangeEnd = 87168, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 87172, XrefRangeEnd = 87191, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 87191, XrefRangeEnd = 87197, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe VibeRemoconReinforcePanelView()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
		System.IntPtr intPtr = IL2CPP.il2cpp_runtime_invoke(NativeMethodInfoPtr__ctor_Public_Void_0, IL2CPP.Il2CppObjectBaseToPtrNotNull(this), (void**)param, ref exc);
	...
	static VibeRemoconReinforcePanelView()
	{
		Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ExposureUnnoticed2.ObjectUI.VibeRemoconReinforcePanel", "VibeRemoconReinforcePanelView");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr);
		NativeFieldInfoPtr_MaxLevel = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, "MaxLevel");
		NativeFieldInfoPtr_reinforceButton = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, "reinforceButton");
		NativeFieldInfoPtr_currentLevelText = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, "currentLevelText");
		NativeFieldInfoPtr_costText = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, "costText");
		NativeFieldInfoPtr_reinforceCost = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, "reinforceCost");
		NativeMethodInfoPtr_Initialize_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, 100669678);
		NativeMethodInfoPtr_RefreshView_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, 100669679);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, 100669680);
		NativeMethodInfoPtr_OnClickReinforce_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, 100669681);
		NativeMethodInfoPtr_Open_Public_Static_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, 100669682);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VibeRemoconReinforcePanelView>.NativeClassPtr, 100669683);
	}

	public VibeRemoconReinforcePanelView(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
