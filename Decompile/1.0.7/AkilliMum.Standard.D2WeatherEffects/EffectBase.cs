...
public class EffectBase : MonoBehaviour
{
	...
	{
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40802, XrefRangeEnd = 40806, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		get
		{
			IntPtr* param = null;
		...
		[CallerCount(0)]
		[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40806, XrefRangeEnd = 40810, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static EffectBase()
	{
		Il2CppClassPointerStore<EffectBase>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "AkilliMum.Standard.D2WeatherEffects", "EffectBase");
		...
		NativeMethodInfoPtr_get_InsideRendering_Public_Static_get_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EffectBase>.NativeClassPtr, 100665545);
		NativeMethodInfoPtr_set_InsideRendering_Public_Static_set_Void_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EffectBase>.NativeClassPtr, 100665546);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EffectBase>.NativeClassPtr, 100665547);
	}
