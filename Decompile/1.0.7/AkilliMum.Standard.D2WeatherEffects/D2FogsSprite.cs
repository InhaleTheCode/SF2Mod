...
public class D2FogsSprite : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40228, XrefRangeEnd = 40300, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40300, XrefRangeEnd = 40306, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe D2FogsSprite()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static D2FogsSprite()
	{
		Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "AkilliMum.Standard.D2WeatherEffects", "D2FogsSprite");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr);
		NativeFieldInfoPtr_CamTransform = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "CamTransform");
		NativeFieldInfoPtr__firstPosition = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "_firstPosition");
		NativeFieldInfoPtr__difference = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "_difference");
		NativeFieldInfoPtr_CameraSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "CameraSpeedMultiplier");
		NativeFieldInfoPtr_Color = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "Color");
		NativeFieldInfoPtr_TopFade = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "TopFade");
		NativeFieldInfoPtr_RightFade = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "RightFade");
		NativeFieldInfoPtr_BottomFade = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "BottomFade");
		NativeFieldInfoPtr_LeftFade = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "LeftFade");
		NativeFieldInfoPtr_FadeMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "FadeMultiplier");
		NativeFieldInfoPtr_Size = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "Size");
		NativeFieldInfoPtr_HorizontalSpeed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "HorizontalSpeed");
		NativeFieldInfoPtr_VerticalSpeed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "VerticalSpeed");
		NativeFieldInfoPtr_Density = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "Density");
		NativeFieldInfoPtr_EffectedMaterials = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, "EffectedMaterials");
		NativeMethodInfoPtr_Awake_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, 100665524);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, 100665525);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2FogsSprite>.NativeClassPtr, 100665526);
	}

	public D2FogsSprite(IntPtr pointer)
		: base(pointer)
	{
	}
}
