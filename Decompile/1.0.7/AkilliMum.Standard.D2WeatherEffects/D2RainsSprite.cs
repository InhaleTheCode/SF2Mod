...
public class D2RainsSprite : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40522, XrefRangeEnd = 40605, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40605, XrefRangeEnd = 40611, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe D2RainsSprite()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static D2RainsSprite()
	{
		Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "AkilliMum.Standard.D2WeatherEffects", "D2RainsSprite");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr);
		NativeFieldInfoPtr_CamTransform = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "CamTransform");
		NativeFieldInfoPtr__firstPosition = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "_firstPosition");
		NativeFieldInfoPtr__difference = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "_difference");
		NativeFieldInfoPtr_CameraSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "CameraSpeedMultiplier");
		NativeFieldInfoPtr_Color = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "Color");
		NativeFieldInfoPtr_TopFade = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "TopFade");
		NativeFieldInfoPtr_RightFade = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "RightFade");
		NativeFieldInfoPtr_BottomFade = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "BottomFade");
		NativeFieldInfoPtr_LeftFade = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "LeftFade");
		NativeFieldInfoPtr_FadeMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "FadeMultiplier");
		NativeFieldInfoPtr_ParticleMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "ParticleMultiplier");
		NativeFieldInfoPtr_Tail = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "Tail");
		NativeFieldInfoPtr_Speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "Speed");
		NativeFieldInfoPtr_Direction = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "Direction");
		NativeFieldInfoPtr_Luminance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "Luminance");
		NativeFieldInfoPtr_Zoom = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "Zoom");
		NativeFieldInfoPtr_EffectedMaterials = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, "EffectedMaterials");
		NativeMethodInfoPtr_Awake_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, 100665535);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, 100665536);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2RainsSprite>.NativeClassPtr, 100665537);
	}

	public D2RainsSprite(IntPtr pointer)
		: base(pointer)
	{
	}
}
