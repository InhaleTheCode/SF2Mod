...
public class D2RainsFastPE : EffectBase
{
	...
	public unsafe float Exposure
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Exposure);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Exposure)) = num;
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40306, XrefRangeEnd = 40313, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40313, XrefRangeEnd = 40404, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40404, XrefRangeEnd = 40410, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe D2RainsFastPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static D2RainsFastPE()
	{
		Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "AkilliMum.Standard.D2WeatherEffects", "D2RainsFastPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr);
		NativeFieldInfoPtr_CamTransform = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "CamTransform");
		NativeFieldInfoPtr__firstPosition = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "_firstPosition");
		NativeFieldInfoPtr__difference = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "_difference");
		NativeFieldInfoPtr_CameraSpeedMultiplier = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "CameraSpeedMultiplier");
		NativeFieldInfoPtr_Color = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "Color");
		NativeFieldInfoPtr_Noise = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "Noise");
		NativeFieldInfoPtr_Density = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "Density");
		NativeFieldInfoPtr_Speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "Speed");
		NativeFieldInfoPtr_Exposure = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "Exposure");
		NativeFieldInfoPtr_Direction = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "Direction");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_Awake_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, 100665527);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, 100665528);
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, 100665529);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<D2RainsFastPE>.NativeClassPtr, 100665530);
	}

	public D2RainsFastPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
