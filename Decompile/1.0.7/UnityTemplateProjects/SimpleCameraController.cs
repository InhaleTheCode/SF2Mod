...
public class SimpleCameraController : MonoBehaviour
{
	public class CameraState : Il2CppSystem.Object
	{
		...
		[CallerCount(6)]
		[CachedScanResults(RefRangeStart = 32640, RefRangeEnd = 32646, XrefRangeStart = 32640, XrefRangeEnd = 32646, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(3)]
		[CachedScanResults(RefRangeStart = 32648, RefRangeEnd = 32651, XrefRangeStart = 32648, XrefRangeEnd = 32651, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		[CallerCount(3)]
		[CachedScanResults(RefRangeStart = 32661, RefRangeEnd = 32664, XrefRangeStart = 32661, XrefRangeEnd = 32664, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
		...
		static CameraState()
		{
			...
			NativeMethodInfoPtr_SetFromTransform_Public_Void_Transform_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CameraState>.NativeClassPtr, 100665321);
			NativeMethodInfoPtr_Translate_Public_Void_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CameraState>.NativeClassPtr, 100665322);
			NativeMethodInfoPtr_LerpTowards_Public_Void_CameraState_Single_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CameraState>.NativeClassPtr, 100665323);
			NativeMethodInfoPtr_UpdateTransform_Public_Void_Transform_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CameraState>.NativeClassPtr, 100665324);
			NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CameraState>.NativeClassPtr, 100665325);
		}
	...
	[CallerCount(3)]
	[CachedScanResults(RefRangeStart = 32702, RefRangeEnd = 32705, XrefRangeStart = 32702, XrefRangeEnd = 32705, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 34554, XrefRangeEnd = 34605, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 34605, XrefRangeEnd = 34621, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static SimpleCameraController()
	{
		...
		NativeMethodInfoPtr_OnEnable_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleCameraController>.NativeClassPtr, 100665317);
		NativeMethodInfoPtr_GetInputTranslationDirection_Private_Vector3_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleCameraController>.NativeClassPtr, 100665318);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleCameraController>.NativeClassPtr, 100665319);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleCameraController>.NativeClassPtr, 100665320);
	}
