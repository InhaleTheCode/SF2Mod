...
public class MissionCrouchMoveNaked : MissionBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 71001, XrefRangeEnd = 71012, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 71012, XrefRangeEnd = 71014, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 71014, XrefRangeEnd = 71015, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 71015, XrefRangeEnd = 71016, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	public unsafe MissionCrouchMoveNaked()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static MissionCrouchMoveNaked()
	{
		Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ExposureUnnoticed2.Scripts.Mission", "MissionCrouchMoveNaked");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr);
		NativeFieldInfoPtr_startPathPosition = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, "startPathPosition");
		NativeFieldInfoPtr_oldResult = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, "oldResult");
		NativeFieldInfoPtr_PathSearchCount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, "PathSearchCount");
		NativeFieldInfoPtr_lastMaxPathLength = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, "lastMaxPathLength");
		NativeMethodInfoPtr_IsInCondition_Public_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, 100668444);
		NativeMethodInfoPtr_GetAddSatisfy_Protected_Virtual_Single_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, 100668445);
		NativeMethodInfoPtr_IsRpPerSecCondition_Protected_Virtual_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, 100668446);
		NativeMethodInfoPtr_Reset_Public_Virtual_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, 100668447);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<MissionCrouchMoveNaked>.NativeClassPtr, 100668448);
	}

	public MissionCrouchMoveNaked(IntPtr pointer)
		: base(pointer)
	{
	}
}
