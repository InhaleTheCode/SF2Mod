...
public class PlayerMoistureManager : Il2CppSystem.Object
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 54823, XrefRangeEnd = 54832, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	public unsafe PlayerMoistureManager()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PlayerMoistureManager>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static PlayerMoistureManager()
	{
		Il2CppClassPointerStore<PlayerMoistureManager>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ExposureUnnoticed2.Object3D.Player.Scripts", "PlayerMoistureManager");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PlayerMoistureManager>.NativeClassPtr);
		NativeFieldInfoPtr_pca = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PlayerMoistureManager>.NativeClassPtr, "pca");
		NativeMethodInfoPtr_Initialize_Public_Void_PlayerClassAccessor_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PlayerMoistureManager>.NativeClassPtr, 100666869);
		NativeMethodInfoPtr_OnUpdate_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PlayerMoistureManager>.NativeClassPtr, 100666870);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PlayerMoistureManager>.NativeClassPtr, 100666871);
	}

	public PlayerMoistureManager(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
