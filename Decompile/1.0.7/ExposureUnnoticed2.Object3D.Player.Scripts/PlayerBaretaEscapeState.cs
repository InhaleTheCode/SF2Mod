...
public class PlayerBaretaEscapeState : Il2CppSystem.Object
{
	...
	[CallerCount(1)]
	[CachedScanResults(RefRangeStart = 50634, RefRangeEnd = 50635, XrefRangeStart = 50598, XrefRangeEnd = 50634, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	public unsafe PlayerBaretaEscapeState()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PlayerBaretaEscapeState>.NativeClassPtr))
	{
		System.IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out System.IntPtr exc);
	...
	static PlayerBaretaEscapeState()
	{
		Il2CppClassPointerStore<PlayerBaretaEscapeState>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ExposureUnnoticed2.Object3D.Player.Scripts", "PlayerBaretaEscapeState");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PlayerBaretaEscapeState>.NativeClassPtr);
		NativeFieldInfoPtr_pca = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PlayerBaretaEscapeState>.NativeClassPtr, "pca");
		NativeMethodInfoPtr_Initialize_Public_Void_PlayerClassAccessor_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PlayerBaretaEscapeState>.NativeClassPtr, 100666519);
		NativeMethodInfoPtr_OnUpdate_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PlayerBaretaEscapeState>.NativeClassPtr, 100666520);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PlayerBaretaEscapeState>.NativeClassPtr, 100666521);
	}

	public PlayerBaretaEscapeState(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
