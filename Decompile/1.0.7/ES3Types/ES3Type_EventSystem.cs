...
public class ES3Type_EventSystem : ES3ComponentType
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 15581, XrefRangeEnd = 15596, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_EventSystem()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_EventSystem>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 15596, XrefRangeEnd = 15612, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_EventSystem()
	{
		Il2CppClassPointerStore<ES3Type_EventSystem>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_EventSystem");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_EventSystem>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_EventSystem>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_EventSystem>.NativeClassPtr, 100664525);
		NativeMethodInfoPtr_WriteComponent_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_EventSystem>.NativeClassPtr, 100664526);
		NativeMethodInfoPtr_ReadComponent_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_EventSystem>.NativeClassPtr, 100664527);
	}

	public ES3Type_EventSystem(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
