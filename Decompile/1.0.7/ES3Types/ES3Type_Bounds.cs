...
public class ES3Type_Bounds : ES3Type
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18815, XrefRangeEnd = 18830, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_Bounds()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_Bounds>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18830, XrefRangeEnd = 18844, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18844, XrefRangeEnd = 18853, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_Bounds()
	{
		Il2CppClassPointerStore<ES3Type_Bounds>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_Bounds");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_Bounds>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_Bounds>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Bounds>.NativeClassPtr, 100664581);
		NativeMethodInfoPtr_Write_Public_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Bounds>.NativeClassPtr, 100664582);
		NativeMethodInfoPtr_Read_Public_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Bounds>.NativeClassPtr, 100664583);
	}

	public ES3Type_Bounds(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
