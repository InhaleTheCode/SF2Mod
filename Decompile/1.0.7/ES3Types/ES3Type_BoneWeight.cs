...
public class ES3Type_BoneWeight : ES3Type
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18706, XrefRangeEnd = 18721, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_BoneWeight()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_BoneWeight>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18721, XrefRangeEnd = 18767, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18767, XrefRangeEnd = 18798, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_BoneWeight()
	{
		Il2CppClassPointerStore<ES3Type_BoneWeight>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_BoneWeight");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_BoneWeight>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_BoneWeight>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_BoneWeight>.NativeClassPtr, 100664577);
		NativeMethodInfoPtr_Write_Public_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_BoneWeight>.NativeClassPtr, 100664578);
		NativeMethodInfoPtr_Read_Public_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_BoneWeight>.NativeClassPtr, 100664579);
	}

	public ES3Type_BoneWeight(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
