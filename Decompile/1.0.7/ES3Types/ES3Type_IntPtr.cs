...
public class ES3Type_IntPtr : ES3Type
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13726, XrefRangeEnd = 13741, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_IntPtr()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_IntPtr>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13741, XrefRangeEnd = 13745, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 13745, XrefRangeEnd = 13751, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_IntPtr()
	{
		Il2CppClassPointerStore<ES3Type_IntPtr>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_IntPtr");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_IntPtr>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_IntPtr>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_IntPtr>.NativeClassPtr, 100664454);
		NativeMethodInfoPtr_Write_Public_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_IntPtr>.NativeClassPtr, 100664455);
		NativeMethodInfoPtr_Read_Public_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_IntPtr>.NativeClassPtr, 100664456);
	}

	public ES3Type_IntPtr(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
