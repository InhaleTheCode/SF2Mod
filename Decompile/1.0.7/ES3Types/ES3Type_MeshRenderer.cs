...
public class ES3Type_MeshRenderer : ES3ComponentType
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 16168, XrefRangeEnd = 16183, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_MeshRenderer()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_MeshRenderer>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 16183, XrefRangeEnd = 16303, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 16303, XrefRangeEnd = 16472, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_MeshRenderer()
	{
		Il2CppClassPointerStore<ES3Type_MeshRenderer>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_MeshRenderer");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_MeshRenderer>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_MeshRenderer>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_MeshRenderer>.NativeClassPtr, 100664540);
		NativeMethodInfoPtr_WriteComponent_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_MeshRenderer>.NativeClassPtr, 100664541);
		NativeMethodInfoPtr_ReadComponent_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_MeshRenderer>.NativeClassPtr, 100664542);
	}

	public ES3Type_MeshRenderer(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
