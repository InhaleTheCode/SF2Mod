...
public class ES3Type_CapsuleCollider : ES3ComponentType
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 15392, XrefRangeEnd = 15407, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_CapsuleCollider()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_CapsuleCollider>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 15407, XrefRangeEnd = 15488, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 15488, XrefRangeEnd = 15581, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_CapsuleCollider()
	{
		Il2CppClassPointerStore<ES3Type_CapsuleCollider>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_CapsuleCollider");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_CapsuleCollider>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_CapsuleCollider>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_CapsuleCollider>.NativeClassPtr, 100664522);
		NativeMethodInfoPtr_WriteComponent_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_CapsuleCollider>.NativeClassPtr, 100664523);
		NativeMethodInfoPtr_ReadComponent_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_CapsuleCollider>.NativeClassPtr, 100664524);
	}

	public ES3Type_CapsuleCollider(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
