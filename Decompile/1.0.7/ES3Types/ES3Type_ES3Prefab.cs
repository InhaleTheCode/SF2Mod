...
public class ES3Type_ES3Prefab : ES3Type
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 10784, XrefRangeEnd = 10799, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_ES3Prefab()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_ES3Prefab>.NativeClassPtr))
	{
	...
	static ES3Type_ES3Prefab()
	{
		Il2CppClassPointerStore<ES3Type_ES3Prefab>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_ES3Prefab");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_ES3Prefab>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_ES3Prefab>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_ES3Prefab>.NativeClassPtr, 100664263);
		NativeMethodInfoPtr_Write_Public_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_ES3Prefab>.NativeClassPtr, 100664264);
		NativeMethodInfoPtr_Read_Public_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_ES3Prefab>.NativeClassPtr, 100664265);
	}

	public ES3Type_ES3Prefab(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
