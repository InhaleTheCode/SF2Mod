...
public class ES3Type_SkinnedMeshRenderer : ES3ComponentType
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 26345, XrefRangeEnd = 26360, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_SkinnedMeshRenderer()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_SkinnedMeshRenderer>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 26360, XrefRangeEnd = 26537, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 26537, XrefRangeEnd = 26768, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_SkinnedMeshRenderer()
	{
		Il2CppClassPointerStore<ES3Type_SkinnedMeshRenderer>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_SkinnedMeshRenderer");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_SkinnedMeshRenderer>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_SkinnedMeshRenderer>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_SkinnedMeshRenderer>.NativeClassPtr, 100664761);
		NativeMethodInfoPtr_WriteComponent_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_SkinnedMeshRenderer>.NativeClassPtr, 100664762);
		NativeMethodInfoPtr_ReadComponent_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_SkinnedMeshRenderer>.NativeClassPtr, 100664763);
	}

	public ES3Type_SkinnedMeshRenderer(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
