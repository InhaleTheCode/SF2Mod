...
public class ES3Type_SphereCollider : ES3ComponentType
{
	...
	{
		internal static System.IntPtr Pointer = IL2CPP.il2cpp_method_get_from_reflection(IL2CPP.Il2CppObjectBaseToPtrNotNull(new MethodInfo(IL2CPP.il2cpp_method_get_object(NativeMethodInfoPtr_ReadComponent_Protected_Virtual_Void_ES3Reader_Object_0, Il2CppClassPointerStore<ES3Type_SphereCollider>.NativeClassPtr)).MakeGenericMethod(new Il2CppReferenceArray<Il2CppSystem.Type>(new Il2CppSystem.Type[1] { Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<T>.NativeClassPtr)) }))));
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 17853, XrefRangeEnd = 17868, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_SphereCollider()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_SphereCollider>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 17868, XrefRangeEnd = 17929, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 17929, XrefRangeEnd = 18003, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_SphereCollider()
	{
		Il2CppClassPointerStore<ES3Type_SphereCollider>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_SphereCollider");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_SphereCollider>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_SphereCollider>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_SphereCollider>.NativeClassPtr, 100664559);
		NativeMethodInfoPtr_WriteComponent_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_SphereCollider>.NativeClassPtr, 100664560);
		NativeMethodInfoPtr_ReadComponent_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_SphereCollider>.NativeClassPtr, 100664561);
	}

	public ES3Type_SphereCollider(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
