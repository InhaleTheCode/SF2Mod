...
public class ES3Type_Material : ES3UnityObjectType
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 22570, XrefRangeEnd = 22585, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_Material()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_Material>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 22585, XrefRangeEnd = 22695, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 22695, XrefRangeEnd = 22704, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 22704, XrefRangeEnd = 22834, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_Material()
	{
		Il2CppClassPointerStore<ES3Type_Material>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_Material");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_Material>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_Material>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Material>.NativeClassPtr, 100664687);
		NativeMethodInfoPtr_WriteUnityObject_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Material>.NativeClassPtr, 100664688);
		NativeMethodInfoPtr_ReadUnityObject_Protected_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Material>.NativeClassPtr, 100664689);
		NativeMethodInfoPtr_ReadUnityObject_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Material>.NativeClassPtr, 100664690);
	}

	public ES3Type_Material(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
