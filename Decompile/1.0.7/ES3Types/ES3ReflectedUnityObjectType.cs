...
public class ES3ReflectedUnityObjectType : ES3UnityObjectType
{
	private sealed class MethodInfoStoreGeneric_ReadUnityObject_Protected_Virtual_Object_ES3Reader_0<T>
	{
		internal static System.IntPtr Pointer = IL2CPP.il2cpp_method_get_from_reflection(IL2CPP.Il2CppObjectBaseToPtrNotNull(new MethodInfo(IL2CPP.il2cpp_method_get_object(NativeMethodInfoPtr_ReadUnityObject_Protected_Virtual_Object_ES3Reader_0, Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr)).MakeGenericMethod(new Il2CppReferenceArray<Il2CppSystem.Type>(new Il2CppSystem.Type[1] { Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<T>.NativeClassPtr)) }))));
	}

	private sealed class MethodInfoStoreGeneric_ReadUnityObject_Protected_Virtual_Void_ES3Reader_Object_0<T>
	{
		internal static System.IntPtr Pointer = IL2CPP.il2cpp_method_get_from_reflection(IL2CPP.Il2CppObjectBaseToPtrNotNull(new MethodInfo(IL2CPP.il2cpp_method_get_object(NativeMethodInfoPtr_ReadUnityObject_Protected_Virtual_Void_ES3Reader_Object_0, Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr)).MakeGenericMethod(new Il2CppReferenceArray<Il2CppSystem.Type>(new Il2CppSystem.Type[1] { Il2CppSystem.Type.internal_from_handle(IL2CPP.il2cpp_class_get_type(Il2CppClassPointerStore<T>.NativeClassPtr)) }))));
	}
	...
	public unsafe ES3ReflectedUnityObjectType([DefaultParameterValue(null)] Il2CppSystem.Type type)
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 14179, XrefRangeEnd = 14184, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3ReflectedUnityObjectType()
	{
		Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3ReflectedUnityObjectType");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr);
		NativeMethodInfoPtr__ctor_Public_Void_Type_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr, 100664505);
		NativeMethodInfoPtr_WriteUnityObject_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr, 100664506);
		NativeMethodInfoPtr_ReadUnityObject_Protected_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr, 100664507);
		NativeMethodInfoPtr_ReadUnityObject_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3ReflectedUnityObjectType>.NativeClassPtr, 100664508);
	}

	public ES3ReflectedUnityObjectType(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
