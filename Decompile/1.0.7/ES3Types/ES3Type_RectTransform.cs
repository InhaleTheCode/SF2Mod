...
public class ES3Type_RectTransform : ES3ComponentType
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 24430, XrefRangeEnd = 24445, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_RectTransform()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_RectTransform>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 24445, XrefRangeEnd = 24563, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 24563, XrefRangeEnd = 24726, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_RectTransform()
	{
		Il2CppClassPointerStore<ES3Type_RectTransform>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_RectTransform");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_RectTransform>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_RectTransform>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_RectTransform>.NativeClassPtr, 100664728);
		NativeMethodInfoPtr_WriteComponent_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_RectTransform>.NativeClassPtr, 100664729);
		NativeMethodInfoPtr_ReadComponent_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_RectTransform>.NativeClassPtr, 100664730);
	}

	public ES3Type_RectTransform(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
