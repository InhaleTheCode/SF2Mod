...
public class ES3Type_LayerMask : ES3Type
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 21057, XrefRangeEnd = 21072, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_LayerMask()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_LayerMask>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 21072, XrefRangeEnd = 21081, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 21081, XrefRangeEnd = 21094, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_LayerMask()
	{
		Il2CppClassPointerStore<ES3Type_LayerMask>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_LayerMask");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_LayerMask>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_LayerMask>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_LayerMask>.NativeClassPtr, 100664669);
		NativeMethodInfoPtr_Write_Public_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_LayerMask>.NativeClassPtr, 100664670);
		NativeMethodInfoPtr_Read_Public_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_LayerMask>.NativeClassPtr, 100664671);
	}

	public ES3Type_LayerMask(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
