...
public class ES3Type_ForceOverLifetimeModule : ES3Type
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 19959, XrefRangeEnd = 19974, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_ForceOverLifetimeModule()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_ForceOverLifetimeModule>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 19974, XrefRangeEnd = 20045, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 20052, XrefRangeEnd = 20143, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_ForceOverLifetimeModule()
	{
		Il2CppClassPointerStore<ES3Type_ForceOverLifetimeModule>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_ForceOverLifetimeModule");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_ForceOverLifetimeModule>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_ForceOverLifetimeModule>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_ForceOverLifetimeModule>.NativeClassPtr, 100664628);
		NativeMethodInfoPtr_Write_Public_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_ForceOverLifetimeModule>.NativeClassPtr, 100664629);
		NativeMethodInfoPtr_Read_Public_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_ForceOverLifetimeModule>.NativeClassPtr, 100664630);
		NativeMethodInfoPtr_ReadInto_Public_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_ForceOverLifetimeModule>.NativeClassPtr, 100664631);
	}

	public ES3Type_ForceOverLifetimeModule(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
