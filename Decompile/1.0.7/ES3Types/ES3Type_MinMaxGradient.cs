...
public class ES3Type_MinMaxGradient : ES3Type
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 23497, XrefRangeEnd = 23512, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_MinMaxGradient()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_MinMaxGradient>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 23512, XrefRangeEnd = 23546, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 23546, XrefRangeEnd = 23600, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_MinMaxGradient()
	{
		Il2CppClassPointerStore<ES3Type_MinMaxGradient>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_MinMaxGradient");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_MinMaxGradient>.NativeClassPtr);
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_MinMaxGradient>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_MinMaxGradient>.NativeClassPtr, 100664704);
		NativeMethodInfoPtr_Write_Public_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_MinMaxGradient>.NativeClassPtr, 100664705);
		NativeMethodInfoPtr_Read_Public_Virtual_Object_ES3Reader_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_MinMaxGradient>.NativeClassPtr, 100664706);
	}

	public ES3Type_MinMaxGradient(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
