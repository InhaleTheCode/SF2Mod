...
public class ES3Type_Transform : ES3ComponentType
{
	...
	public unsafe static int countRead
	{
		get
		{
			System.Runtime.CompilerServices.Unsafe.SkipInit(out int result);
			IL2CPP.il2cpp_field_static_get_value(NativeFieldInfoPtr_countRead, &result);
			return result;
		}
		set
		{
			IL2CPP.il2cpp_field_static_set_value(NativeFieldInfoPtr_countRead, &num);
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18342, XrefRangeEnd = 18357, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ES3Type_Transform()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ES3Type_Transform>.NativeClassPtr))
	{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18357, XrefRangeEnd = 18402, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 18402, XrefRangeEnd = 18464, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static ES3Type_Transform()
	{
		Il2CppClassPointerStore<ES3Type_Transform>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ES3Types", "ES3Type_Transform");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ES3Type_Transform>.NativeClassPtr);
		NativeFieldInfoPtr_countRead = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_Transform>.NativeClassPtr, "countRead");
		NativeFieldInfoPtr_Instance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ES3Type_Transform>.NativeClassPtr, "Instance");
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Transform>.NativeClassPtr, 100664565);
		NativeMethodInfoPtr_WriteComponent_Protected_Virtual_Void_Object_ES3Writer_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Transform>.NativeClassPtr, 100664566);
		NativeMethodInfoPtr_ReadComponent_Protected_Virtual_Void_ES3Reader_Object_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ES3Type_Transform>.NativeClassPtr, 100664567);
	}

	public ES3Type_Transform(System.IntPtr pointer)
		: base(pointer)
	{
	}
}
