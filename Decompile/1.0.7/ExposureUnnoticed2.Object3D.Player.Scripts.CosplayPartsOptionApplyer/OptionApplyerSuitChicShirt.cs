...
public class OptionApplyerSuitChicShirt : MonoBehaviour
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 59271, XrefRangeEnd = 59303, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 59303, XrefRangeEnd = 59315, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 59315, XrefRangeEnd = 59320, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 59320, XrefRangeEnd = 59346, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe OptionApplyerSuitChicShirt()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static OptionApplyerSuitChicShirt()
	{
		Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ExposureUnnoticed2.Object3D.Player.Scripts.CosplayPartsOptionApplyer", "OptionApplyerSuitChicShirt");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr);
		NativeFieldInfoPtr_partsId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, "partsId");
		NativeFieldInfoPtr_meshRenderer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, "meshRenderer");
		NativeFieldInfoPtr_uniqueId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, "uniqueId");
		NativeFieldInfoPtr_mats = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, "mats");
		NativeFieldInfoPtr_MainTex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, "MainTex");
		NativeFieldInfoPtr_BaseColor = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, "BaseColor");
		NativeFieldInfoPtr_FirstShadeColor = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, "FirstShadeColor");
		NativeMethodInfoPtr_Awake_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, 100667217);
		NativeMethodInfoPtr_OnDestroy_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, 100667218);
		NativeMethodInfoPtr_OnChangeEvent_Private_Void_ChangeCosplayPartsOptionEvent_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, 100667219);
		NativeMethodInfoPtr_ApplyFromGameState_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, 100667220);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerSuitChicShirt>.NativeClassPtr, 100667221);
	}

	public OptionApplyerSuitChicShirt(IntPtr pointer)
		: base(pointer)
	{
	}
}
