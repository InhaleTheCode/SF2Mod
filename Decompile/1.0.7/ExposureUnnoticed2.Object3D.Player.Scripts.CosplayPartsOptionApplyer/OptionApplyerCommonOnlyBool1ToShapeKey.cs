...
public class OptionApplyerCommonOnlyBool1ToShapeKey : MonoBehaviour
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 58556, XrefRangeEnd = 58588, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 58588, XrefRangeEnd = 58600, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 58600, XrefRangeEnd = 58604, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 58604, XrefRangeEnd = 58611, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	public unsafe OptionApplyerCommonOnlyBool1ToShapeKey()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static OptionApplyerCommonOnlyBool1ToShapeKey()
	{
		Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "ExposureUnnoticed2.Object3D.Player.Scripts.CosplayPartsOptionApplyer", "OptionApplyerCommonOnlyBool1ToShapeKey");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr);
		NativeFieldInfoPtr_cosplayType = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, "cosplayType");
		NativeFieldInfoPtr_partsId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, "partsId");
		NativeFieldInfoPtr_shapeKeyIndex = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, "shapeKeyIndex");
		NativeFieldInfoPtr_activeBlend = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, "activeBlend");
		NativeFieldInfoPtr_meshRenderer = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, "meshRenderer");
		NativeFieldInfoPtr_uniqueId = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, "uniqueId");
		NativeFieldInfoPtr_mats = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, "mats");
		NativeMethodInfoPtr_Awake_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, 100667158);
		NativeMethodInfoPtr_OnDestroy_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, 100667159);
		NativeMethodInfoPtr_OnChangeEvent_Private_Void_ChangeCosplayPartsOptionEvent_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, 100667160);
		NativeMethodInfoPtr_ApplyFromGameState_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, 100667161);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<OptionApplyerCommonOnlyBool1ToShapeKey>.NativeClassPtr, 100667162);
	}

	public OptionApplyerCommonOnlyBool1ToShapeKey(IntPtr pointer)
		: base(pointer)
	{
	}
}
