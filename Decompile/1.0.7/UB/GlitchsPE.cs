...
public class GlitchsPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37271, XrefRangeEnd = 37332, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37332, XrefRangeEnd = 37338, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe GlitchsPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static GlitchsPE()
	{
		Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "GlitchsPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr);
		NativeFieldInfoPtr_Noise = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr, "Noise");
		NativeFieldInfoPtr_Speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr, "Speed");
		NativeFieldInfoPtr_Size = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr, "Size");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr, 100665435);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<GlitchsPE>.NativeClassPtr, 100665436);
	}

	public GlitchsPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
