...
public class ColorsChannelPE : EffectBase
{
	...
	public unsafe float Red
	{
		...
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Red)) = num;
		}
	}
	...
	public unsafe float Green
	{
		...
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Green)) = num;
		}
	}
	...
	public unsafe float Blue
	{
		...
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Blue)) = num;
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 36092, XrefRangeEnd = 36158, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 36158, XrefRangeEnd = 36164, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ColorsChannelPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static ColorsChannelPE()
	{
		Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "ColorsChannelPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr);
		NativeFieldInfoPtr_Red = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr, "Red");
		NativeFieldInfoPtr_Green = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr, "Green");
		NativeFieldInfoPtr_Blue = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr, "Blue");
		NativeFieldInfoPtr_Luminance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr, "Luminance");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr, 100665403);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ColorsChannelPE>.NativeClassPtr, 100665404);
	}

	public ColorsChannelPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
