...
public class SimpleRotater : MonoBehaviour
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 35262, XrefRangeEnd = 35267, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	{
		Il2CppClassPointerStore<SimpleRotater>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "SimpleRotater");
		...
		NativeMethodInfoPtr_FixedUpdate_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleRotater>.NativeClassPtr, 100665373);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleRotater>.NativeClassPtr, 100665374);
	}
