...
public class CrosshatchsPE : EffectBase
{
	...
	public unsafe int Detail
	{
		...
		set
		{
			*(int*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Detail)) = num;
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 36164, XrefRangeEnd = 36230, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 36230, XrefRangeEnd = 36236, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe CrosshatchsPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static CrosshatchsPE()
	{
		Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "CrosshatchsPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr);
		NativeFieldInfoPtr_Color1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr, "Color1");
		NativeFieldInfoPtr_Color2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr, "Color2");
		NativeFieldInfoPtr_Size = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr, "Size");
		NativeFieldInfoPtr_Detail = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr, "Detail");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr, 100665405);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<CrosshatchsPE>.NativeClassPtr, 100665406);
	}

	public CrosshatchsPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
