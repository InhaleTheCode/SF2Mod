...
public class PosterizesPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37778, XrefRangeEnd = 37829, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37829, XrefRangeEnd = 37835, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PosterizesPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PosterizesPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static PosterizesPE()
	{
		Il2CppClassPointerStore<PosterizesPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "PosterizesPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PosterizesPE>.NativeClassPtr);
		NativeFieldInfoPtr_Level = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PosterizesPE>.NativeClassPtr, "Level");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PosterizesPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PosterizesPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PosterizesPE>.NativeClassPtr, 100665451);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PosterizesPE>.NativeClassPtr, 100665452);
	}

	public PosterizesPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
