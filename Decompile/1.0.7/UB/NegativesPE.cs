...
public class NegativesPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37659, XrefRangeEnd = 37705, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37705, XrefRangeEnd = 37711, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe NegativesPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<NegativesPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static NegativesPE()
	{
		Il2CppClassPointerStore<NegativesPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "NegativesPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<NegativesPE>.NativeClassPtr);
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NegativesPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<NegativesPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NegativesPE>.NativeClassPtr, 100665447);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<NegativesPE>.NativeClassPtr, 100665448);
	}

	public NegativesPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
