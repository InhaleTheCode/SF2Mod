...
public class RadialVolumesPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37907, XrefRangeEnd = 37968, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37968, XrefRangeEnd = 37974, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe RadialVolumesPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static RadialVolumesPE()
	{
		Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "RadialVolumesPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr);
		NativeFieldInfoPtr_Size = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr, "Size");
		NativeFieldInfoPtr_Step = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr, "Step");
		NativeFieldInfoPtr_Smooth = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr, "Smooth");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr, 100665455);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<RadialVolumesPE>.NativeClassPtr, 100665456);
	}

	public RadialVolumesPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
