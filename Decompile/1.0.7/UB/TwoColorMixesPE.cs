...
public class TwoColorMixesPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 38515, XrefRangeEnd = 38576, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 38576, XrefRangeEnd = 38582, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe TwoColorMixesPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static TwoColorMixesPE()
	{
		Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "TwoColorMixesPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr);
		NativeFieldInfoPtr_Luminance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr, "Luminance");
		NativeFieldInfoPtr_Color1 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr, "Color1");
		NativeFieldInfoPtr_Color2 = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr, "Color2");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr, 100665473);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<TwoColorMixesPE>.NativeClassPtr, 100665474);
	}

	public TwoColorMixesPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
