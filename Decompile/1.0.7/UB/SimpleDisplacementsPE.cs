...
public class SimpleDisplacementsPE : EffectBase
{
	...
	public unsafe float Amount
	{
		...
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Amount)) = num;
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 38133, XrefRangeEnd = 38194, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 38194, XrefRangeEnd = 38200, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe SimpleDisplacementsPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static SimpleDisplacementsPE()
	{
		Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "SimpleDisplacementsPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr);
		NativeFieldInfoPtr_Amount = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr, "Amount");
		NativeFieldInfoPtr_Speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr, "Speed");
		NativeFieldInfoPtr_Noise = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr, "Noise");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr, 100665461);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleDisplacementsPE>.NativeClassPtr, 100665462);
	}

	public SimpleDisplacementsPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
