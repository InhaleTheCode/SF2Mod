...
public class EmbossPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37003, XrefRangeEnd = 37059, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37059, XrefRangeEnd = 37065, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe EmbossPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<EmbossPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static EmbossPE()
	{
		Il2CppClassPointerStore<EmbossPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "EmbossPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<EmbossPE>.NativeClassPtr);
		NativeFieldInfoPtr_Strength = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EmbossPE>.NativeClassPtr, "Strength");
		NativeFieldInfoPtr_Angle = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EmbossPE>.NativeClassPtr, "Angle");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EmbossPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EmbossPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EmbossPE>.NativeClassPtr, 100665427);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EmbossPE>.NativeClassPtr, 100665428);
	}

	public EmbossPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
