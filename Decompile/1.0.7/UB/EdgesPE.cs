...
public class EdgesPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 36936, XrefRangeEnd = 36997, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 36997, XrefRangeEnd = 37003, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe EdgesPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static EdgesPE()
	{
		Il2CppClassPointerStore<EdgesPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "EdgesPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr);
		NativeFieldInfoPtr_Threshold = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr, "Threshold");
		NativeFieldInfoPtr_Color = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr, "Color");
		NativeFieldInfoPtr_BackgroundColor = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr, "BackgroundColor");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr, 100665425);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<EdgesPE>.NativeClassPtr, 100665426);
	}

	public EdgesPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
