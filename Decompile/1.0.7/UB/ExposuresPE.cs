...
public class ExposuresPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37065, XrefRangeEnd = 37116, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37116, XrefRangeEnd = 37122, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe ExposuresPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<ExposuresPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static ExposuresPE()
	{
		Il2CppClassPointerStore<ExposuresPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "ExposuresPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<ExposuresPE>.NativeClassPtr);
		NativeFieldInfoPtr_Power = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ExposuresPE>.NativeClassPtr, "Power");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ExposuresPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<ExposuresPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ExposuresPE>.NativeClassPtr, 100665429);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ExposuresPE>.NativeClassPtr, 100665430);
	}

	public ExposuresPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
