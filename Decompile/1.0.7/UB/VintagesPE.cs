...
public class VintagesPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 38773, XrefRangeEnd = 38824, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 38824, XrefRangeEnd = 38830, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe VintagesPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<VintagesPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static VintagesPE()
	{
		Il2CppClassPointerStore<VintagesPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "VintagesPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<VintagesPE>.NativeClassPtr);
		NativeFieldInfoPtr_Luminance = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VintagesPE>.NativeClassPtr, "Luminance");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VintagesPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<VintagesPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VintagesPE>.NativeClassPtr, 100665481);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<VintagesPE>.NativeClassPtr, 100665482);
	}

	public VintagesPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
