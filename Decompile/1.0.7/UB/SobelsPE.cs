...
public class SobelsPE : EffectBase
{
	...
	public unsafe float Detail
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Detail);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Detail)) = num;
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 38257, XrefRangeEnd = 38313, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 38313, XrefRangeEnd = 38319, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe SobelsPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<SobelsPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static SobelsPE()
	{
		Il2CppClassPointerStore<SobelsPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "SobelsPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<SobelsPE>.NativeClassPtr);
		NativeFieldInfoPtr_Color = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SobelsPE>.NativeClassPtr, "Color");
		NativeFieldInfoPtr_Detail = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SobelsPE>.NativeClassPtr, "Detail");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SobelsPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<SobelsPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SobelsPE>.NativeClassPtr, 100665465);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SobelsPE>.NativeClassPtr, 100665466);
	}

	public SobelsPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
