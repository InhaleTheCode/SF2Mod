...
public class DistortedLensPE : EffectBase
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 36745, XrefRangeEnd = 36796, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 36796, XrefRangeEnd = 36802, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe DistortedLensPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<DistortedLensPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static DistortedLensPE()
	{
		Il2CppClassPointerStore<DistortedLensPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "DistortedLensPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<DistortedLensPE>.NativeClassPtr);
		NativeFieldInfoPtr_Power = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DistortedLensPE>.NativeClassPtr, "Power");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DistortedLensPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<DistortedLensPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DistortedLensPE>.NativeClassPtr, 100665419);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<DistortedLensPE>.NativeClassPtr, 100665420);
	}

	public DistortedLensPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
