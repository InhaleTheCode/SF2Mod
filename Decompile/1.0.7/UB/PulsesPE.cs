...
public class PulsesPE : EffectBase
{
	...
	private static readonly IntPtr NativeFieldInfoPtr_Iteration;
	...
	public unsafe float Iteration
	{
		get
		{
			nint num = (nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Iteration);
			return *(float*)num;
		}
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Iteration)) = num;
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37835, XrefRangeEnd = 37901, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37901, XrefRangeEnd = 37907, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe PulsesPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static PulsesPE()
	{
		Il2CppClassPointerStore<PulsesPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "PulsesPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr);
		NativeFieldInfoPtr_Speed = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr, "Speed");
		NativeFieldInfoPtr_Iteration = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr, "Iteration");
		NativeFieldInfoPtr_Min = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr, "Min");
		NativeFieldInfoPtr_Max = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr, "Max");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr, 100665453);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<PulsesPE>.NativeClassPtr, 100665454);
	}

	public PulsesPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
