...
public class HeatsPE : EffectBase
{
	...
	public unsafe float Light
	{
		...
		set
		{
			*(float*)((nint)IL2CPP.Il2CppObjectBaseToPtrNotNull(this) + (int)IL2CPP.il2cpp_field_get_offset(NativeFieldInfoPtr_Light)) = num;
		}
	}
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37338, XrefRangeEnd = 37399, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 37399, XrefRangeEnd = 37405, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	public unsafe HeatsPE()
		: this(IL2CPP.il2cpp_object_new(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr))
	{
		IntPtr* param = null;
		System.Runtime.CompilerServices.Unsafe.SkipInit(out IntPtr exc);
	...
	static HeatsPE()
	{
		Il2CppClassPointerStore<HeatsPE>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "UB", "HeatsPE");
		IL2CPP.il2cpp_runtime_class_init(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr);
		NativeFieldInfoPtr_Threshold = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr, "Threshold");
		NativeFieldInfoPtr_Noise = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr, "Noise");
		NativeFieldInfoPtr_Light = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr, "Light");
		NativeFieldInfoPtr_Shader = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr, "Shader");
		NativeFieldInfoPtr__material = IL2CPP.GetIl2CppField(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr, "_material");
		NativeMethodInfoPtr_OnRenderImage_Private_Void_RenderTexture_RenderTexture_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr, 100665437);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<HeatsPE>.NativeClassPtr, 100665438);
	}

	public HeatsPE(IntPtr pointer)
		: base(pointer)
	{
	}
}
