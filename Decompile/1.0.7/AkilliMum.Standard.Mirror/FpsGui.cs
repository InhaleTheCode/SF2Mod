...
public class FpsGui : MonoBehaviour
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40921, XrefRangeEnd = 40934, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	static FpsGui()
	{
		Il2CppClassPointerStore<FpsGui>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "AkilliMum.Standard.Mirror", "FpsGui");
		...
		NativeMethodInfoPtr_Start_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FpsGui>.NativeClassPtr, 100665567);
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FpsGui>.NativeClassPtr, 100665568);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<FpsGui>.NativeClassPtr, 100665569);
	}
