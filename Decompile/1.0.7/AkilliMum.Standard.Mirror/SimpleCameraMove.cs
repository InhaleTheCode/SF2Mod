...
public class SimpleCameraMove : MonoBehaviour
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40934, XrefRangeEnd = 40986, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	{
		Il2CppClassPointerStore<SimpleCameraMove>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "AkilliMum.Standard.Mirror", "SimpleCameraMove");
		...
		NativeMethodInfoPtr_Update_Private_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleCameraMove>.NativeClassPtr, 100665570);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<SimpleCameraMove>.NativeClassPtr, 100665571);
	}
