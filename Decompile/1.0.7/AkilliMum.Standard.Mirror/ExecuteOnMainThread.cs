...
public class ExecuteOnMainThread : MonoBehaviour
{
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40810, XrefRangeEnd = 40839, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40839, XrefRangeEnd = 40861, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40861, XrefRangeEnd = 40890, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	[CallerCount(0)]
	[CachedScanResults(RefRangeStart = 0, RefRangeEnd = 0, XrefRangeStart = 40890, XrefRangeEnd = 40899, MetadataInitTokenRva = 0L, MetadataInitFlagRva = 0L)]
	...
	{
		Il2CppClassPointerStore<ExecuteOnMainThread>.NativeClassPtr = IL2CPP.GetIl2CppClass("Assembly-CSharp.dll", "AkilliMum.Standard.Mirror", "ExecuteOnMainThread");
		...
		NativeMethodInfoPtr_Execute_Protected_Void_Action_String_Single_Boolean_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ExecuteOnMainThread>.NativeClassPtr, 100665549);
		NativeMethodInfoPtr_CancelExecute_Protected_Void_String_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ExecuteOnMainThread>.NativeClassPtr, 100665550);
		NativeMethodInfoPtr_Update_Protected_Virtual_New_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ExecuteOnMainThread>.NativeClassPtr, 100665551);
		NativeMethodInfoPtr__ctor_Public_Void_0 = IL2CPP.GetIl2CppMethodByToken(Il2CppClassPointerStore<ExecuteOnMainThread>.NativeClassPtr, 100665552);
	}
